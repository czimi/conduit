...
user_variable = random.randint(1, 100)
...
class TestConduitApp(object):
    ...
    # TC3 Sign up with an appropriate password and "dinamic" user datas

    def test_registration_dinamic_userdata(self):
        ...
        username_input.send_keys(f"Próba Pista {user_variable}")
        email_input.send_keys(f"proba_pista_{user_variable}@proba.com")
